...
# ==========================================
    ...
    with tab2:
        ...
        if rule_tech:
            ...
            with st.expander("📌 **แนวทางการเรียนต่อ & วิชาที่ควรเน้นศึกษาเพิ่ม**", expanded=True):
                st.markdown("""
                * **สายการเรียน ม.ปลาย ที่แนะนำ:** วิทย์-คณิต หรือ ศิลป์-คำนวณ (หรือสายอาชีพ/ปวช. ช่างอิเล็กทรอนิกส์/คอมพิวเตอร์)
                * **วิชาที่ควรเน้นในโรงเรียน:** คณิตศาสตร์ (แคลคูลัส, สถิติ, ตรรกศาสตร์) และ ภาษาอังกฤษ
                * **ทักษะที่ควรเรียนรู้เพิ่มนอกห้องเรียน:** การเขียนโปรแกรมภาษาพื้นฐาน (Python, C++, JavaScript), อัลกอริทึม, โครงสร้างข้อมูล และภาษาอังกฤษเพื่อการสื่อสารทางเทคโนโลยี
                """)

            with st.expander("🏫 **แนะนำมหาวิทยาลัยแยกตามงบประมาณ**", expanded=True):
                st.markdown("""
                * **งบน้อย / ต้องการทุนการศึกษา (ค่าเทอมต่ำกว่า 20,000 บาท/เทอม):**
                    * มหาวิทยาลัยรามคำแหง / มสธ. (ค่าเทอมประหยัด เลือกเวลาเรียนได้)
                    * กลุ่มมหาวิทยาลัยราชภัฏ และ มหาวิทยาลัยเทคโนโลยีราชมงคล (RMUT) ทั่วประเทศ
                    * *แนะนำเพิ่มเติม:* ยื่นขอทุน กยศ. หรือทุนคณะครุศาสตร์/ศึกษาศาสตร์ (คอมพิวเตอร์) จบแล้วมีโอกาสรับทุนครูคืนถิ่น
                * **งบปานกลาง (มหาวิทยาลัยรัฐบาลหลัก ค่าเทอม 15,000 - 35,000 บาท/เทอม):**
                    * จุฬาลงกรณ์มหาวิทยาลัย, มหาวิทยาลัยเกษตรศาสตร์, มหาวิทยาลัยมหิดล, มหาวิทยาลัยเชียงใหม่, มหาวิทยาลัยขอนแก่น
                    * กลุ่ม 3 พระจอมเกล้า (สจล., มจธ., มจพ.) เด่นด้านวิศวะและไอที
                * **งบสูง / เน้นหลักสูตรอินเตอร์ หรือเอกชน (ค่าเทอม 50,000 บาทขึ้นไป/เทอม):**
                    * มหาวิทยาลัยกรุงเทพ, มหาวิทยาลัยรังสิต, มหาวิทยาลัยศรีปทุม (อุปกรณ์ทันสมัย คอนเนกชันสายเทคกว้าง)
                    * หลักสูตรนานาชาติ เช่น SIIT มธ. หรือ คณะ ICT มหิดล
                """)
            ...
            with st.expander("📌 **แนวทางการเรียนต่อ & วิชาที่ควรเน้นศึกษาเพิ่ม**", expanded=True):
                st.markdown("""
                * **สายการเรียน ม.ปลาย ที่แนะนำ:** วิทย์-คณิต
                * **วิชาที่ควรเน้นในโรงเรียน:** ชีววิทยา, เคมี, และ ฟิสิกส์
                * **ทักษะที่ควรเรียนรู้เพิ่มนอกห้องเรียน:** ทักษะจิตวิทยาการสื่อสาร, ความรู้พื้นฐานปฐมพยาบาล, ทักษะภาษาอังกฤษเพื่อใช้จำศัพท์เฉพาะทางวิชาการ
                """)

            with st.expander("🏫 **แนะนำมหาวิทยาลัยแยกตามงบประมาณ**", expanded=True):
                st.markdown("""
                * **งบน้อย / ต้องการทุนผูกพันจบแล้วมีงานทำทันที:**
                    * วิทยาลัยพยาบาลบรมราชชนนี (สถาบันพระบรมราชชนก) มีทุนเรียนฟรี มีเบี้ยเลี้ยง และจบแล้วบรรจุทำงานในโรงพยาบาลรัฐทันที
                    * วิทยาลัยพยาบาลกองทัพบก / กองทัพเรือ / ทหารอากาศ / ตำรวจ (มีทุนการศึกษาและยศราชการ)
                * **งบปานกลาง (มหาวิทยาลัยรัฐบาล ค่าเทอม 15,000 - 30,000 บาท/เทอม):**
                    * มหาวิทยาลัยมหิดล (ศิริราช/รามาธิบดี), จุฬาลงกรณ์มหาวิทยาลัย, มหาวิทยาลัยเชียงใหม่, มหาวิทยาลัยสงขลานครินทร์, มหาวิทยาลัยบูรพา
                * **งบสูง / มหาวิทยาลัยเอกชน (ค่าเทอม 40,000 - 80,000 บาทขึ้นไป/เทอม):**
                    * มหาวิทยาลัยหัวเฉียวเฉลิมพระเกียรติ, มหาวิทยาลัยรังสิต, มหาวิทยาลัยสยาม
                """)
            ...
            with st.expander("📌 **แนวทางการเรียนต่อ & วิชาที่ควรเน้นศึกษาเพิ่ม**", expanded=True):
                st.markdown("""
                * **สายการเรียน ม.ปลาย ที่แนะนำ:** ศิลป์-คำนวณ, ศิลป์-ภาษา, ศิลป์-ดิจิทัล/คอมพิวเตอร์ (หรือทุกสายที่มีความสนใจด้านศิลปะ)
                * **วิชาที่ควรเน้นในโรงเรียน:** ศิลปะ, ภาษาอังกฤษ, ภาษาไทย (การจับใจความและเล่าเรื่อง)
                * **ทักษะที่ควรเรียนรู้เพิ่มนอกห้องเรียน:** การใช้โปรแกรมออกแบบ (Adobe Photoshop, Illustrator, Figma), ทักษะการตัดต่อวิดีโอ (Premiere Pro, CapCut), การสะสมผลงาน (Portfolio) และการศึกษาเทรนด์การตลาดดิจิทัล
                """)

            with st.expander("🏫 **แนะนำมหาวิทยาลัยแยกตามงบประมาณ**", expanded=True):
                st.markdown("""
                * **งบน้อย / เน้นประหยัด (ค่าเทอม 10,000 - 20,000 บาท/เทอม):**
                    * มหาวิทยาลัยเทคโนโลยีราชมงคล (เช่น มทร.รัตนโกสินทร์ เพาะช่าง, มทร.ธัญบุรี)
                    * มหาวิทยาลัยราชภัฏ (คณะมนุษยศาสตร์/นิเทศศาสตร์/ศิลปกรรมศาสตร์) ค่าเทอมประหยัด อุปกรณ์ครบถ้วน
                * **งบปานกลาง (มหาวิทยาลัยรัฐบาลสายสร้างสรรค์ ค่าเทอม 18,000 - 35,000 บาท/เทอม):**
                    * มหาวิทยาลัยศิลปากร (ต้นตำรับสายศิลปะและนิเทศ), จุฬาลงกรณ์มหาวิทยาลัย (สถาปัตย์/นิเทศ), มหาวิทยาลัยธรรมศาสตร์, มหาวิทยาลัยศรีนครินทรวิโรฒ (มศว)
                * **งบสูง / มหาวิทยาลัยเอกชนอุปกรณ์ระดับสตูดิโอ (ค่าเทอม 45,000 - 70,000 บาทขึ้นไป/เทอม):**
                    * มหาวิทยาลัยกรุงเทพ (คณะนิเทศศาสตร์ / คณะดิจิทัลมีเดีย โดดเด่นด้านอุปกรณ์ระดับมืออาชีพ)
                    * มหาวิทยาลัยรังสิต, มหาวิทยาลัยศรีปทุม (มีสาขาเกม การ์ตูน และการออกแบบดิจิทัลเฉพาะทาง)
                """)
            ...
            with st.expander("📌 **แนวทางการเรียนต่อ & วิชาที่ควรเน้นศึกษาเพิ่ม**", expanded=True):
                st.markdown("""
                * **สายการเรียน ม.ปลาย ที่แนะนำ:** ศิลป์-คำนวณ, ศิลป์-ภาษา หรือ วิทย์-คณิต
                * **วิชาที่ควรเน้นในโรงเรียน:** ภาษาไทย, ภาษาอังกฤษ, สังคมศึกษา และ คณิตศาสตร์พื้นฐาน/สถิติ
                * **ทักษะที่ควรเรียนรู้เพิ่มนอกห้องเรียน:** ภาษาที่ 3 (เช่น จีน, ญี่ปุ่น, เกาหลี, สเปน), ทักษะการพูดนำเสนอ (Presentation), ความรู้พื้นฐานการทำธุรกิจและการตลาดออนไลน์
                """)

            with st.expander("🏫 **แนะนำมหาวิทยาลัยแยกตามงบประมาณ**", expanded=True):
                st.markdown("""
                * **งบน้อย / เน้นการทำงานควบคู่ (ค่าเทอมต่ำกว่า 15,000 บาท/เทอม):**
                    * มหาวิทยาลัยรามคำแหง (คณะบริหาร, รัฐศาสตร์, นิติศาสตร์, มนุษยศาสตร์ สามารถจัดเวลาเรียนเองได้ง่าย)
                    * มหาวิทยาลัยสุโขทัยธรรมาธิราช (เรียนทางไกล)
                    * กลุ่มมหาวิทยาลัยราชภัฏทั่วประเทศ สามารถกู้ยืม กยศ. เรียนได้สะดวก
                * **งบปานกลาง (มหาวิทยาลัยรัฐบาลชั้นนำ ค่าเทอม 15,000 - 30,000 บาท/เทอม):**
                    * มหาวิทยาลัยธรรมศาสตร์ (เด่นด้านนิติศาสตร์, รัฐศาสตร์, บริหารธุรกิจ ชานม/ท่าพระจันทร์)
                    * จุฬาลงกรณ์มหาวิทยาลัย (พาณิชยศาสตร์และการบัญชี, อักษรศาสตร์), มหาวิทยาลัยเกษตรศาสตร์, มหาวิทยาลัยเชียงใหม่
                * **งบสูง / มหาวิทยาลัยนานาชาติหรือเอกชน (ค่าเทอม 45,000 บาทขึ้นไป/เทอม):**
                    * มหาวิทยาลัยอัสสัมชัญ (ABAC - เด่นการเรียนการสอนเป็นภาษาอังกฤษทั้งหมด)
