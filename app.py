...
# ---------------------------------------------------------
def get_custom_career(mbti_type, top_subject):
    subject_careers = {
        "ศิลปะ/ออกแบบ": {"base": "ศิลปิน / นักออกแบบ", "icon": "🎨"},
        "วิทยาศาสตร์/เคมี/ชีวา": {"base": "นักวิจัย / นักวิทยาศาสตร์", "icon": "🔬"},
        "คณิตศาสตร์/ฟิสิกส์": {"base": "นักวิเคราะห์ / วิศวกร", "icon": "📐"},
    ...
    mbti_styles = {
        "INTJ": "เน้นโครงสร้าง ระบบเรขาคณิต วางกลยุทธ์ระยะยาว และใช้ตรรกะเชิงซ้อน",
        "INTP": "เน้นทดลองแนวคิดแปลกใหม่ ทฤษฎีแนวคิดเชิงปรัชญา และความสมบูรณ์แบบเชิงตรรกะ",
        "ENTJ": "เน้นงานสเกลใหญ่ การบริหารจัดการโปรเจกต์เชิงพาณิชย์ และการนำเสนอที่มีพลัง",
        "ENTP": "เน้นความล้ำยุค ผสมผสานนวัตกรรม และท้าทายกรอบเดิมๆ",
        "INFJ": "เน้นการสื่อความหมายเชิงสัญลักษณ์ อารมณ์ความรู้สึกสะเทือนใจ และอุดมคติ",
        "INFP": "เน้นความรู้สึกส่วนตัว เรื่องเล่าที่มีความหมายลึกซึ้ง และงานที่เป็นเอกลักษณ์เฉพาะตัว",
        "ENFJ": "เน้นการสร้างแรงบันดาลใจ การขับเคลื่อนสังคม และการเข้าถึงผู้คนจำนวนมาก",
        "ENFP": "เน้นความหลากอารมณ์ สดใส มีเรื่องราวหลากหลายมุมมอง และไม่ยึดติดกฎเกณฑ์",
        "ISTJ": "เน้นความประณีต สมจริง สมบูรณ์แบบทุกรายละเอียด และอิงตามกติการูปแบบมาตรฐาน",
        "ISFJ": "เน้นความประณีตอ่อนโยน การดูแลเก็บรายละเอียด และสร้างความสบายใจให้ผู้ดู",
        "ESTJ": "เน้นการบริหารจัดการจริง การผลิตผลงานอย่างมีประสิทธิภาพ และทำตามเป้าหมายชัดเจน",
        "ESFJ": "เน้นตอบโจทย์ความต้องการของผู้คน การทำงานร่วมกับชุมชน และสร้างความสุขให้ผู้ชม",
        "ISTP": "เน้นเทคนิคเชิงช่าง การลงมือทำจริง การแก้ปัญหาเฉพาะหน้า และกลไกที่แม่นยำ",
        "ISFP": "เน้นสุนทรียภาพทางอารมณ์ ความงามแบบธรรมชาติ และการถ่ายทอดตัวตนอย่างตรงไปตรงมา",
        "ESTP": "เน้นความตื่นเต้น ประสบการณ์จริงสดๆ ผลงานที่มีความแอ็กชันและมีอิมแพ็กทันที",
        "ESFP": "เน้นความสนุกสนาน การสร้างความบันเทิง และการดึงดูดความสนใจจากผู้ฟัง/ผู้ชม"
    }

    career_info = subject_careers.get(top_subject, {"base": "ผู้เชี่ยวชาญเฉพาะทาง", "icon": "💼"})
    style_desc = mbti_styles.get(mbti_type, "เน้นการประยุกต์ใช้ทักษะเฉพาะตัว")

    return {
        "title": f"{career_info['base']} (สไตล์ {mbti_type})",
